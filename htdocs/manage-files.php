                ...
                <?php
                    ...
                    if ( $count_for_pagination > 0 ) {
                        ...
                        $thead_columns		= array(
                                                    ...
                                                    array(
                                                        'content'		=> __('Assigned Names','cftp_admin'),
                                                        'hide'			=> 'phone',
                        ...
                        while ( $row = $sql->fetch() ) {
                            ...
                            foreach($clients as $id => $name) {
                                if (in_array($id, $file->assignments_clients)) {
                            ...
                            $tbody_cells = array(
                                                    ...
                                                    array(
                                                        'content'		=> $userNames,//'<span class="label label-' . $assigned_class .'">' . $assigned_status . '</span>',
                                                        'condition'		=> ( $conditions['is_not_client'] && !$conditions['is_search_on'] ),
                                                    ),
                                                    array(
