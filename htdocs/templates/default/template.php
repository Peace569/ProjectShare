                    ...
                    <?php
                        ...
                        if (isset($count) && $count > 0) {
                            ...
                            foreach ($available_files as $file_id) {
                                ...
                                $file->get($file_id);
                                $down_sql = $dbh->prepare("SELECT * FROM tbl_downloads  WHERE file_id = ".$file_id);
                                $down_sql->execute();
                                $down_count=$down_sql->rowCount();
                                ...
                                /** Checkbox */
                                $checkbox = ($file->expired == false) ? '<input type="checkbox" name="files[]" value="' . $file->id . '" class="batch_checkbox"'.($down_count==1 ? checked : "").'/>' : null;
